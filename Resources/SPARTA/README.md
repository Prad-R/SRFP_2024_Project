To build the SPARTA library with the Kokkos package and the FFT package enabled along with GPU parallelisation, go to the [cmake](SPARTA/cmake) directory and use the following commands : -
