...
- For point-by-point footpad temperature sensor data measure by the Viking Landers, the relevant files are included in [VL_Point-by-Point_Footpad_Temp](Climatic_Data/Martian/VL_Point-by_Point_Footpad_Temp).[^2]
