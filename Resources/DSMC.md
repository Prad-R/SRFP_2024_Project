...
- **General Information**
	...
	- It models fluid flows using probabilistic simulation molecules to solve the [Boltzmann equation](https://en.wikipedia.org/wiki/Boltzmann_equation). Here's the [link to the section](#boltzmann-equation) discussing it in brief.
- **DSMC Algorithm**
